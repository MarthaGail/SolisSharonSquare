...
- (void)loadView {
  ...
  UIBarItem* space = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:
    ...
    // Fource action button
    UIBarButtonItem *shareButton = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(shareAction)] autorelease];
  ...
  _toolbar.items = [NSArray arrayWithObjects:
                    space, _previousButton, space, _nextButton, space, shareButton, space, nil];
